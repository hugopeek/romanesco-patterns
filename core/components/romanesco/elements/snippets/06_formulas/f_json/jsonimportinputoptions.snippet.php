...
foreach ($optionsArray['groups'] as $group) {
    ...
    $existingGroup = $modx->getObject('FractalFarming\Romanesco\rmOptionGroup', array(
        'key' => $group['key']
    ));
    ...
    // If group doesn't exist, create it
        ...
        $newGroup = $modx->newObject('FractalFarming\Romanesco\rmOptionGroup', array(
            'name' => $group['name'],
    ...
    foreach ($group['options'] as $option) {
        ...
        $existingOption = $modx->getObject('FractalFarming\Romanesco\rmOption', array(
            'alias' => $option['alias'],
            'key' => $oldKey,
        ));
        ...
        // Or create new option
            ...
            $newOption = $modx->newObject('FractalFarming\Romanesco\rmOption', array(
                'name' => $option['name'],
