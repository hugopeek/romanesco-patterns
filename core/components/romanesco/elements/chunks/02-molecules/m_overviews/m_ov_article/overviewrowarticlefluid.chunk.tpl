...
<div class="[[+cols]] wide middle aligned column">
    ...
    <p>
        ...
        <span class="meta">
            <em>[[%romanesco.article.written_by]] <a href="[[~[[+team_member_id]]]]">[[+author_id:userinfo=`fullname`:empty=`[[++site_name]]`]]</a> [[%romanesco.article.written_on]] [[+publishedon:strtotime:date=`%e %B %Y`]]</em>
        </span>
    </p>
