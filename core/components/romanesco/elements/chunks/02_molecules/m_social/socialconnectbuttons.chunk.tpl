<span class="buttons social connect" vocab="http://schema.org/" typeof="[[++client_type:ucfirst:empty=`Organization`]]">
    <meta property="name" content="[[++site_name]]">
    [[[[If?
        &subject=`[[++social_twitter]]`
        &operator=`notempty`
        &then=`$buttonSocialConnectTwitter? &classes=`[[+button_type]]``
    ]]]]
    [[[[If?
    ...
    [[[[If?
        ...
        &operator=`notempty`
        &then=`$buttonSocialConnectPinterest? &classes=`[[+button_type]]``
    ]]]]
    [[[[If?
    ...
    [[[[If?
        ...
        &operator=`notempty`
        &then=`$buttonSocialConnectGithub? &classes=`[[+button_type]]``
    ]]]]
</span>