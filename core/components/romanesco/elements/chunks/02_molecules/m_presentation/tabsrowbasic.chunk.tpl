[[Switch?
    ...
    &toPlaceholder=`menu_attachment_[[+uid]]`
]]
[[+tab_type:contains=`basic`:then=`basic vertical`:else=`[[+menu_attachment_[[+uid]]]]`:toPlaceholder=`tab_segment`]]
