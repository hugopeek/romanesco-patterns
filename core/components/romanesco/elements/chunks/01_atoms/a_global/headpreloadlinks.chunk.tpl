...
<link rel="preload" href="https://fonts.googleapis.com/css?family=[[+font_page.1]]:[[+font_page.2:empty=`300`]]&display=swap&subset=[[+font_page.3:empty=`latin`]]" as="style">
`]]
[[+font_header.1:notempty=`
<link rel="preload" href="https://fonts.googleapis.com/css?family=[[+font_header.1]]:[[+font_header.2:empty=`700`]]&display=swap&subset=[[+font_header.3:empty=`latin`]]" as="style">
`]]
