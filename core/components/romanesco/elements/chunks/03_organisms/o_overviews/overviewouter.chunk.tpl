...
<div id="[[If? &subject=`[[+prefix]]` &operator=`is` &operand=`ov__` &then=`ov_[[Time]]` &else=`[[+prefix]]`]]">
    <div class="ui [[+cols]] [[+[[+prefix]].grid_settings]] [[+responsive:replace=`,== `]] [[+alignment]] [[+padding]] nested overview [[+[[+prefix]].box_type]]">
    ...
    [[[[+pagination:eq=`1`:then=`$paginationFluid? &prefix=`[[+prefix]]``]]]]
</div>