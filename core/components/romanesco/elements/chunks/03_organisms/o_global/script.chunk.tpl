[[++minify_css_js:eq=`1`:then=`.min`:toPlaceholder=`min`]]
...
<script src="[[++romanesco.semantic_dist_path]]/components/modal[[+min]].js"></script>
<script src="[[++romanesco.semantic_vendor_path]]/tablesort/tablesort.min.js"></script>
<script src="[[++romanesco.semantic_js_path]]/hub[[+min]].js"></script>
`]]
...
<script src="[[++romanesco.semantic_js_path]]/site[[+min]].js?v=[[++romanesco.assets_version_js]]"></script>
[[++footer_additional]]
