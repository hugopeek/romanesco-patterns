    ...
    <main id="main" role="main">
        <div class="ui very relaxed grid container">
            <article id="content" class="sixteen wide mobile eleven wide computer publication column">
                ...
                <aside id="author-about" class="ui vertical stripe segment [[++layout_background_default]]">
                    <div class="ui container">
                        <div class="ui segment">
                            <div class="ui two column equal width grid">
                                <div class="four wide column">
                                    <a href="[[~[[+team_member_id]]]]" class="ui image">
                                        [[ImagePlus:empty=`[[++overview_img_fallback]]`? &tvname=`person_image` &docid=`[[+team_member_id]]` &options=`w=400&h=400&zc=1` &type=`tpl`]]
                                    </a>
                                </div>
                                <div class="column">
                                    [[getResources?
                ...
                <section id="comments" class="ui vertical stripe segment [[++layout_background_default]]">
                    <div class="ui container">
                ...
                <footer class="ui vertical stripe segment [[++layout_background_default]]">
                    <div class="ui container">
