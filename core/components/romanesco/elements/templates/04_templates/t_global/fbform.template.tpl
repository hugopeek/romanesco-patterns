...
<form id="form-[[+title]]" class="ui [[*fb_form_size]] [[+segment_type:eq=`none`:then=`basic`]] form" name="fb[[*id]]" action="[[~[[+current_id]]]]" method="post" enctype="multipart/form-data">
    ...
    <div class="ui [[+segment_type]]">
        ...
        <div class="ui [[+padding]] [[+segment_type:ne=`none`:then=`segment`]]">
            <input class="[[*fb_form_size]] primary ui button" type="submit" name="submit-[[+title]]" value="[[*fb_submit_button:default=`[[%formblocks.form.submit_button]]`]]">
        </div>
        `]]
    </div>
</form>
