...
<form id="form-[[*alias]]" class="ui [[+form_size]] [[+segment_type:eq=`none`:then=`basic`]] registration form" name="fb[[*id]]" action="[[~[[+host_id:empty=`0`]]]]" method="post" enctype="multipart/form-data">
